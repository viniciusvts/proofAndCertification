...
(function ssw(window, document, console, querySelector, querySelectorAll) {
  ...
  function setCountdown() {
    ...
    var aux = this.timeInMili; // obtem quantas horas faltam e diminui a diferença

    var hours = Math.floor(aux / hourInMilli);
    aux = aux - hours * hourInMilli; // obtem quantas minuutos faltam e diminui a diferença

    var min = Math.floor(aux / minInMilli);
    aux = aux - min * minInMilli; // obtem quantas segundos faltam e diminui a diferença

    var sec = Math.floor(aux / secInMilli); // printa no contador
